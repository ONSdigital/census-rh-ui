...
class RHTestCase(AioHTTPTestCase):
    ...
    def setUp(self):
        ...
        self.eq_payload_cy = {
            ...
            "display_address": f"{self.uac_json['address']['addressLine1']}, {self.uac_json['address']['addressLine2']}",
            "response_id": self.response_id,
            "account_service_url": f"{self.app['ACCOUNT_SERVICE_URL']}{self.app['URL_PATH_PREFIX']}/dechrau/save-and-exit",
            "channel": self.channel,
            "user_id": "",
            "questionnaire_id": self.questionnaire_id,
            "eq_id": self.eq_id,
        ...
        self.eq_payload_ni_ga = {
            ...
            "display_address": f"{self.uac_json['address']['addressLine1']}, {self.uac_json['address']['addressLine2']}",
            "response_id": self.response_id,
            "account_service_url": f"{self.app['ACCOUNT_SERVICE_URL']}{self.app['URL_PATH_PREFIX']}/ni/start/save-and-exit",
            "channel": self.channel,
            "user_id": "",
            "questionnaire_id": self.questionnaire_id,
            "eq_id": self.eq_id,
