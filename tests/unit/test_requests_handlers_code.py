...
class TestRequestsHandlersAccessCodeCommon(RHTestCase):
    # Tests of pages/steps in all paths

    @unittest_run_loop
    async def test_post_request_access_code_enter_address_empty_ew(
            self):
    ...
    @unittest_run_loop
    async def test_post_request_access_code_enter_address_empty_cy(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm:
            response = await self.client.request('GET',
    ...
    @unittest_run_loop
    async def test_post_request_access_code_enter_address_empty_ni(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm:
            response = await self.client.request('GET',
    ...
    @unittest_run_loop
    async def test_post_request_access_code_enter_address_invalid_postcode_en(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm:
            response = await self.client.request('POST',
                                                 self.post_request_access_code_enter_address_en,
    ...
    @unittest_run_loop
    async def test_post_request_access_code_enter_address_invalid_postcode_cy(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm:
            response = await self.client.request('POST',
                                                 self.post_request_access_code_enter_address_cy,
    ...
    @unittest_run_loop
    async def test_post_request_access_code_enter_address_invalid_postcode_ni(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm:
            response = await self.client.request('POST',
                                                 self.post_request_access_code_enter_address_ni,
    ...
    async def test_post_request_access_code_select_address_no_selection_ew(
        ...
        with self.assertLogs('respondent-home', 'INFO') as cm, \
            ...
            self.assertEqual(post_enter_address_response.status, 200)
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_address_no_results_ew(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, \
                mock.patch('app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode:
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_address_no_results_cy(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, \
                mock.patch('app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode:
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_address_no_results_ni(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, \
                mock.patch('app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode:
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_empty_hh_ew_e(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
                'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
            ...
            await self.client.request('POST', self.post_request_access_code_enter_address_en,
                                      data=self.common_postcode_input_valid)

            await self.client.request('POST', self.post_request_access_code_select_address_en,
                                      data=self.common_select_address_input_valid)

            response = await self.client.request('POST', self.post_request_access_code_confirm_address_en,
                                                 data=self.common_confirm_address_input_yes)
            ...
            self.assertIn(self.content_request_code_select_method_secondary_en, str(resp_content))
            self.assertIn(self.content_request_code_select_method_option_text_en, str(resp_content))
            self.assertIn(self.content_request_code_select_method_option_post_en, str(resp_content))

            response = await self.client.request('POST', self.post_request_access_code_select_method_en,
                                                 data=self.common_form_data_empty)
            ...
            self.assertEqual(response.status, 200)
            resp_content = await response.content.read()
            self.assertIn(self.content_request_code_select_method_error_en, str(resp_content))

    @unittest_run_loop
    async def test_post_request_access_code_select_method_empty_hh_ew_w(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
                'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_empty_hh_cy(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
                'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
            ...
            await self.client.request('POST', self.post_request_access_code_enter_address_cy,
                                      data=self.common_postcode_input_valid)

            await self.client.request('POST', self.post_request_access_code_select_address_cy,
                                      data=self.common_select_address_input_valid)

            response = await self.client.request('POST', self.post_request_access_code_confirm_address_cy,
                                                 data=self.common_confirm_address_input_yes)
            ...
            self.assertIn(self.content_request_code_select_method_secondary_cy, str(resp_content))
            self.assertIn(self.content_request_code_select_method_option_text_cy, str(resp_content))
            self.assertIn(self.content_request_code_select_method_option_post_cy, str(resp_content))

            response = await self.client.request('POST', self.post_request_access_code_select_method_cy,
                                                 data=self.common_form_data_empty)
            ...
            self.assertEqual(response.status, 200)
            resp_content = await response.content.read()
            self.assertIn(self.content_request_code_select_method_error_cy, str(resp_content))

    @unittest_run_loop
    async def test_post_request_access_code_select_method_empty_hh_ni(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
                'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
            ...
            await self.client.request('POST', self.post_request_access_code_enter_address_ni,
                                      data=self.common_postcode_input_valid)

            await self.client.request('POST', self.post_request_access_code_select_address_ni,
                                      data=self.common_select_address_input_valid)

            response = await self.client.request('POST', self.post_request_access_code_confirm_address_ni,
                                                 data=self.common_confirm_address_input_yes)
            ...
            response = await self.client.request('POST', self.post_request_access_code_select_method_ni,
                                                 data=self.common_form_data_empty)
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_empty_spg_ew_e(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
            'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_empty_spg_ew_w(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
            'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_empty_spg_cy(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
            'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_empty_spg_ni(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
            'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_empty_select_manager_ce_m_ew_e(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
            'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
            ...
            await self.client.request('POST', self.post_request_access_code_confirm_address_en,
                                      data=self.common_confirm_address_input_yes)
            ...
            self.assertIn('<a href="/cy/requests/access-code/select-method/" lang="cy" >Cymraeg</a>',
                          str(resp_content))
            self.assertIn(self.content_request_code_select_method_manager_title_en, str(resp_content))
            self.assertIn(self.content_request_code_select_method_secondary_en, str(resp_content))
            self.assertIn(self.content_request_code_select_method_option_text_en, str(resp_content))
            self.assertIn(self.content_request_code_select_method_option_post_en, str(resp_content))
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_empty_select_manager_ce_m_ew_w(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
            'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_empty_select_manager_ce_m_cy(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
            'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
            ...
            await self.client.request('POST', self.post_request_access_code_confirm_address_cy,
                                      data=self.common_confirm_address_input_yes)
            ...
            self.assertIn('<a href="/en/requests/access-code/select-method/" lang="en" >English</a>',
                          str(resp_content))
            self.assertIn(self.content_request_code_select_method_manager_title_cy, str(resp_content))
            self.assertIn(self.content_request_code_select_method_secondary_cy, str(resp_content))
            self.assertIn(self.content_request_code_select_method_option_text_cy, str(resp_content))
            self.assertIn(self.content_request_code_select_method_option_post_cy, str(resp_content))
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_empty_select_manager_ce_m_ni(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
            'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
            ...
            await self.client.request('POST', self.post_request_access_code_confirm_address_ni,
                                      data=self.common_confirm_address_input_yes)
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_empty_select_resident_ce_m_ew_e(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
            'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_empty_select_resident_ce_m_ew_w(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
            'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_empty_select_resident_ce_m_cy(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
            'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_empty_select_resident_ce_m_ni(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
            'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_empty_ce_r_ew_e(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
            'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_empty_ce_r_ew_w(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
            'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_empty_ce_r_cy(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
            'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_empty_ce_r_ni(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
            'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_invalid_hh_ew_e(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
                'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
            ...
            response = await self.client.request('POST', self.post_request_access_code_select_method_en,
                                                 data=self.request_code_select_method_data_invalid)
            self.assertLogEvent(cm, "received POST on endpoint 'en/requests/access-code/select-method'")
            self.assertLogEvent(cm, "received GET on endpoint 'en/requests/access-code/select-method'")
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_invalid_hh_ew_w(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
                'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_invalid_hh_cy(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
                'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_invalid_hh_ni(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
                'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_invalid_spg_ew_e(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
            'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_invalid_spg_ew_w(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
            'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_invalid_spg_cy(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
            'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_invalid_spg_ni(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
            'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_invalid_select_manager_ce_m_ew_e(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
            'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
            ...
            await self.client.request('POST', self.post_request_access_code_resident_or_manager_en,
                                      data=self.common_resident_or_manager_input_manager)
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_invalid_select_manager_ce_m_ew_w(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
            'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_invalid_select_manager_ce_m_cy(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
            'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
            ...
            await self.client.request('POST', self.post_request_access_code_resident_or_manager_cy,
                                      data=self.common_resident_or_manager_input_manager)
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_invalid_select_manager_ce_m_ni(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
            'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
            ...
            await self.client.request('POST', self.post_request_access_code_resident_or_manager_ni,
                                      data=self.common_resident_or_manager_input_manager)
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_invalid_select_resident_ce_m_ew_e(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
            'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_invalid_select_resident_ce_m_ew_w(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
            'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_invalid_select_resident_ce_m_cy(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
            'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_invalid_select_resident_ce_m_ni(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
            'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_invalid_ce_r_ew_e(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
            'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_invalid_ce_r_ew_w(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
            'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_invalid_ce_r_cy(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
            'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
    ...
    @unittest_run_loop
    async def test_post_request_access_code_select_method_invalid_ce_r_ni(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
            'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            'app.utils.RHService.get_case_by_uprn'
...
class TestRequestsHandlersAccessCodeSMS(RHTestCase):
    ...
    async def test_request_access_code_sms_happy_path_hh_ew_e(
        ...
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
            ...
            self.assertIn(self.content_request_code_sent_sms_secondary_household_en, str(resp_content))
    ...
    async def test_request_access_code_sms_happy_path_hh_cy(
        ...
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
            ...
            self.assertIn(self.content_request_code_sent_sms_secondary_household_cy, str(resp_content))
...
# noinspection PyTypeChecker
class TestRequestsHandlersAccessCodePost(RHTestCase):

    @unittest_run_loop
    async def test_request_access_code_post_confirm_name_address_empty_hh_ew_e(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
            ...
            resp_content = await response.content.read()
            self.assertIn(self.ons_logo_en, str(resp_content))
            self.assertIn('<a href="/cy/requests/access-code/confirm-name-address/" lang="cy" >Cymraeg</a>',
                          str(resp_content))
            self.assertIn(self.content_request_code_confirm_name_address_title_household_en, str(resp_content))
            ...
            self.assertEqual(response.status, 200)
            resp_content = await response.content.read()
            self.assertIn(self.content_request_code_confirm_name_address_error_en, str(resp_content))
            self.assertIn(self.content_request_code_confirm_name_address_title_household_en, str(resp_content))

    @unittest_run_loop
    async def test_request_access_code_post_confirm_name_address_empty_hh_ew_w(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_access_code_post_confirm_name_address_empty_hh_cy(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
            ...
            resp_content = await response.content.read()
            self.assertIn(self.ons_logo_cy, str(resp_content))
            self.assertIn('<a href="/en/requests/access-code/confirm-name-address/" lang="en" >English</a>',
                          str(resp_content))
            self.assertIn(self.content_request_code_confirm_name_address_title_household_cy, str(resp_content))
            ...
            self.assertEqual(response.status, 200)
            resp_content = await response.content.read()
            self.assertIn(self.content_request_code_confirm_name_address_error_cy, str(resp_content))
            self.assertIn(self.content_request_code_confirm_name_address_title_household_cy, str(resp_content))

    @unittest_run_loop
    async def test_request_access_code_post_confirm_name_address_empty_hh_ni(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_access_code_post_confirm_name_address_empty_spg_ew_e(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_access_code_post_confirm_name_address_empty_spg_ew_w(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_access_code_post_confirm_name_address_empty_spg_cy(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_access_code_post_confirm_name_address_empty_spg_ni(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_access_code_post_confirm_name_address_empty_select_manager_ce_m_ew_e(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
            ...
            self.assertIn('<a href="/cy/requests/access-code/confirm-name-address/" lang="cy" >Cymraeg</a>',
                          str(resp_content))
            self.assertIn(self.content_request_code_confirm_name_address_title_manager_en, str(resp_content))
    ...
    @unittest_run_loop
    async def test_request_access_code_post_confirm_name_address_empty_select_manager_ce_m_ew_w(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_access_code_post_confirm_name_address_empty_select_manager_ce_m_cy(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
            ...
            self.assertIn('<a href="/en/requests/access-code/confirm-name-address/" lang="en" >English</a>',
                          str(resp_content))
            self.assertIn(self.content_request_code_confirm_name_address_title_manager_cy, str(resp_content))
    ...
    @unittest_run_loop
    async def test_request_access_code_post_confirm_name_address_empty_select_manager_ce_m_ni(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_access_code_post_confirm_name_address_empty_select_resident_ce_m_ew_e(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
            ...
            self.assertIn('<a href="/cy/requests/access-code/confirm-name-address/" lang="cy" >Cymraeg</a>',
                          str(resp_content))
            self.assertIn(self.content_request_code_confirm_name_address_title_individual_en, str(resp_content))
    ...
    @unittest_run_loop
    async def test_request_access_code_post_confirm_name_address_empty_select_resident_ce_m_ew_w(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_access_code_post_confirm_name_address_empty_select_resident_ce_m_cy(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
            ...
            self.assertIn('<a href="/en/requests/access-code/confirm-name-address/" lang="en" >English</a>',
                          str(resp_content))
            self.assertIn(self.content_request_code_confirm_name_address_title_individual_cy, str(resp_content))
    ...
    @unittest_run_loop
    async def test_request_access_code_post_confirm_name_address_empty_select_resident_ce_m_ni(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_access_code_post_confirm_name_address_empty_ce_r_ew_e(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_access_code_post_confirm_name_address_empty_ce_r_ew_w(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_access_code_post_confirm_name_address_empty_ce_r_cy(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_access_code_post_confirm_name_address_empty_ce_r_ni(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_access_code_post_code_sent_post_hh_ew_e(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
            ...
            self.assertIn(self.content_request_code_sent_post_secondary_household_en, str(resp_content))

    @unittest_run_loop
    async def test_request_access_code_post_code_sent_post_hh_ew_w(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_access_code_post_code_sent_post_hh_cy(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
            ...
            self.assertIn(self.content_request_code_sent_post_secondary_household_cy, str(resp_content))

    @unittest_run_loop
    async def test_request_access_code_post_code_sent_post_hh_ni(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_access_code_post_code_sent_post_spg_ew_e(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_access_code_post_code_sent_post_spg_ew_w(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_access_code_post_code_sent_post_spg_cy(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_access_code_post_code_sent_post_spg_ni(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_access_code_post_code_sent_post_select_manager_ce_m_ew_e(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_access_code_post_code_sent_post_select_manager_ce_m_ew_w(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_access_code_post_code_sent_post_select_manager_ce_m_cy(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_access_code_post_code_sent_post_select_manager_ce_m_ni(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_access_code_post_code_sent_post_select_resident_ce_m_ew_e(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
            ...
            self.assertIn('<a href="/cy/requests/access-code/code-sent-post/" lang="cy" >Cymraeg</a>',
                          str(resp_content))
            self.assertIn(self.content_request_code_sent_post_title_en, str(resp_content))
            self.assertIn(self.content_request_code_sent_post_secondary_individual_en, str(resp_content))

    @unittest_run_loop
    async def test_request_access_code_post_code_sent_post_select_resident_ce_m_ew_w(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_access_code_post_code_sent_post_select_resident_ce_m_cy(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
            ...
            self.assertIn('<a href="/en/requests/access-code/code-sent-post/" lang="en" >English</a>',
                          str(resp_content))
            self.assertIn(self.content_request_code_sent_post_title_cy, str(resp_content))
            self.assertIn(self.content_request_code_sent_post_secondary_individual_cy, str(resp_content))

    @unittest_run_loop
    async def test_request_access_code_post_code_sent_post_select_resident_ce_m_ni(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_access_code_post_code_sent_post_ce_r_ew_e(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_access_code_post_code_sent_post_ce_r_ew_w(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_access_code_post_code_sent_post_ce_r_cy(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_access_code_post_code_sent_post_ce_r_ni(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
...
class TestRequestsHandlersIndividualCode(RHTestCase):
    ...
    @unittest_run_loop
    async def test_request_individual_code_post_code_sent_post_hh_ew_e(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
            ...
            await self.client.request(
                    ...
                    data=self.request_code_select_method_data_post)
            self.assertLogEvent(cm, "received POST on endpoint 'en/requests/individual-code/select-method'")
            self.assertLogEvent(cm, "received GET on endpoint 'en/requests/individual-code/enter-name'")

            await self.client.request(
                    'POST',
                    self.post_request_individual_code_enter_name_en,
                    data=self.request_common_enter_name_form_data_valid)
            self.assertLogEvent(cm, "received POST on endpoint 'en/requests/individual-code/enter-name'")
            self.assertLogEvent(cm, "received GET on endpoint 'en/requests/individual-code/confirm-name-address'")

            response = await self.client.request(
                    'POST',
                    self.post_request_individual_code_confirm_name_address_en,
                    data=self.request_common_confirm_name_address_data_yes)
            self.assertLogEvent(cm, "received POST on endpoint 'en/requests/individual-code/confirm-name-address'")
            self.assertLogEvent(cm, "fulfilment query: case_type=HH, region=E, individual=true")
            self.assertLogEvent(cm, "received GET on endpoint 'en/requests/individual-code/code-sent-post'")

            self.assertEqual(response.status, 200)
            resp_content = await response.content.read()
            self.assertIn(self.ons_logo_en, str(resp_content))
            self.assertIn('<a href="/cy/requests/individual-code/code-sent-post/" lang="cy" >Cymraeg</a>',
                          str(resp_content))
            self.assertIn(self.content_request_code_sent_post_title_en, str(resp_content))
            self.assertIn(self.content_request_code_sent_post_secondary_individual_en, str(resp_content))

    @unittest_run_loop
    async def test_request_individual_code_post_code_sent_post_hh_ew_w(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_individual_code_post_code_sent_post_hh_cy(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
            ...
            await self.client.request(
                    ...
                    data=self.request_code_select_method_data_post)
            self.assertLogEvent(cm, "received POST on endpoint 'cy/requests/individual-code/select-method'")
            self.assertLogEvent(cm, "received GET on endpoint 'cy/requests/individual-code/enter-name'")

            await self.client.request(
                    'POST',
                    self.post_request_individual_code_enter_name_cy,
                    data=self.request_common_enter_name_form_data_valid)
            self.assertLogEvent(cm, "received POST on endpoint 'cy/requests/individual-code/enter-name'")
            self.assertLogEvent(cm, "received GET on endpoint 'cy/requests/individual-code/confirm-name-address'")

            response = await self.client.request(
                    'POST',
                    self.post_request_individual_code_confirm_name_address_cy,
                    data=self.request_common_confirm_name_address_data_yes)
            self.assertLogEvent(cm, "received POST on endpoint 'cy/requests/individual-code/confirm-name-address'")
            self.assertLogEvent(cm, "fulfilment query: case_type=HH, region=W, individual=true")
            self.assertLogEvent(cm, "received GET on endpoint 'cy/requests/individual-code/code-sent-post'")

            self.assertEqual(response.status, 200)
            resp_content = await response.content.read()
            self.assertIn(self.ons_logo_cy, str(resp_content))
            self.assertIn('<a href="/en/requests/individual-code/code-sent-post/" lang="en" >English</a>',
                          str(resp_content))
            self.assertIn(self.content_request_code_sent_post_title_cy, str(resp_content))
            self.assertIn(self.content_request_code_sent_post_secondary_individual_cy, str(resp_content))

    @unittest_run_loop
    async def test_request_individual_code_post_code_sent_post_hh_ni(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
            ...
            await self.client.request(
                    ...
                    data=self.request_code_select_method_data_post)
            self.assertLogEvent(cm, "received POST on endpoint 'ni/requests/individual-code/select-method'")
            self.assertLogEvent(cm, "received GET on endpoint 'ni/requests/individual-code/enter-name'")

            await self.client.request(
                    'POST',
                    self.post_request_individual_code_enter_name_ni,
                    data=self.request_common_enter_name_form_data_valid)
            self.assertLogEvent(cm, "received POST on endpoint 'ni/requests/individual-code/enter-name'")
            self.assertLogEvent(cm, "received GET on endpoint 'ni/requests/individual-code/confirm-name-address'")

            response = await self.client.request(
                    'POST',
                    self.post_request_individual_code_confirm_name_address_ni,
                    data=self.request_common_confirm_name_address_data_yes)
            self.assertLogEvent(cm, "received POST on endpoint 'ni/requests/individual-code/confirm-name-address'")
            self.assertLogEvent(cm, "fulfilment query: case_type=HH, region=N, individual=true")
            self.assertLogEvent(cm, "received GET on endpoint 'ni/requests/individual-code/code-sent-post'")
