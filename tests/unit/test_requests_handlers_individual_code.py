...
class TestRequestsHandlersIndividualCode(TestHelpers):
    ...
    async def test_request_individual_code_sms_happy_path_hh_ew_e(self):
        ...
        await self.post_common_confirm_mobile(self.post_request_individual_code_confirm_mobile_en,
                                              'en', 'HH', 'E', 'true')
    ...
    async def test_request_individual_code_sms_happy_path_hh_cy(self):
        ...
        await self.post_common_confirm_mobile(self.post_request_individual_code_confirm_mobile_cy,
                                              'cy', 'HH', 'W', 'true')
    ...
    async def test_request_individual_code_sms_happy_path_hh_ni(self):
        ...
        await self.post_common_confirm_mobile(self.post_request_individual_code_confirm_mobile_ni,
                                              'ni', 'HH', 'N', 'true')
    ...
    async def test_get_request_individual_code_address_in_scotland_ew(self):
        ...
        await self.get_common_enter_address(self.get_request_individual_code_enter_address_en, 'en')
        await self.post_common_enter_address(self.post_request_individual_code_enter_address_en, 'en')
        await self.post_common_select_address(self.post_request_individual_code_select_address_en,
                                              'en', self.ai_uprn_result_scotland)
        await self.post_common_confirm_address_in_scotland(self.post_request_individual_code_confirm_address_en, 'en')
    ...
    async def test_get_request_individual_code_address_in_scotland_cy(self):
        ...
        await self.get_common_enter_address(self.get_request_individual_code_enter_address_cy, 'cy')
        await self.post_common_enter_address(self.post_request_individual_code_enter_address_cy, 'cy')
        await self.post_common_select_address(self.post_request_individual_code_select_address_cy,
                                              'cy', self.ai_uprn_result_scotland)
        await self.post_common_confirm_address_in_scotland(self.post_request_individual_code_confirm_address_cy, 'cy')
    ...
    async def test_get_request_individual_code_address_in_scotland_ni(self):
        ...
        await self.get_common_enter_address(self.get_request_individual_code_enter_address_ni, 'ni')
        await self.post_common_enter_address(self.post_request_individual_code_enter_address_ni, 'ni')
        await self.post_common_select_address(self.post_request_individual_code_select_address_ni,
                                              'ni', self.ai_uprn_result_scotland)
        await self.post_common_confirm_address_in_scotland(self.post_request_individual_code_confirm_address_ni, 'ni')
    ...
    async def test_get_request_individual_code_address_not_found_ew(self):
        ...
        await self.get_common_enter_address(self.get_request_individual_code_enter_address_en, 'en')
        await self.post_common_enter_address(self.post_request_individual_code_enter_address_en, 'en')
        await self.post_common_select_address_not_found(self.post_request_individual_code_select_address_en, 'en')
    ...
    async def test_get_request_individual_code_address_not_found_cy(self):
        ...
        await self.get_common_enter_address(self.get_request_individual_code_enter_address_cy, 'cy')
        await self.post_common_enter_address(self.post_request_individual_code_enter_address_cy, 'cy')
        await self.post_common_select_address_not_found(self.post_request_individual_code_select_address_cy, 'cy')
    ...
    async def test_get_request_individual_code_address_not_found_ni(self):
        ...
        await self.get_common_enter_address(self.get_request_individual_code_enter_address_ni, 'ni')
        await self.post_common_enter_address(self.post_request_individual_code_enter_address_ni, 'ni')
        await self.post_common_select_address_not_found(self.post_request_individual_code_select_address_ni, 'ni')
    ...
    async def test_get_request_individual_code_census_address_type_na_ew(self):
        ...
        await self.post_common_confirm_address_type_na(self.post_request_individual_code_confirm_address_en, 'en')
    ...
    async def test_get_request_individual_code_census_address_type_na_cy(self):
        ...
        await self.post_common_confirm_address_type_na(self.post_request_individual_code_confirm_address_cy, 'cy')
    ...
    async def test_get_request_individual_code_census_address_type_na_ni(self):
        ...
        await self.post_common_confirm_address_type_na(self.post_request_individual_code_confirm_address_ni, 'ni')
    ...
    async def test_get_request_individual_code_timeout_ew(self):
        await self.get_common_timeout(self.get_request_individual_code_timeout_en, 'en')

    @unittest_run_loop
    async def test_get_request_individual_code_timeout_cy(self):
        await self.get_common_timeout(self.get_request_individual_code_timeout_cy, 'cy')

    @unittest_run_loop
    async def test_get_request_individual_code_timeout_ni(self):
        await self.get_common_timeout(self.get_request_individual_code_timeout_ni, 'ni')
    ...
    async def test_get_request_individual_code_confirm_address_get_cases_error_ew(self):
        ...
        await self.post_common_enter_address(self.post_request_individual_code_enter_address_en, 'en')
        await self.post_common_select_address(self.post_request_individual_code_select_address_en, 'en')
        await self.post_common_confirm_address_get_cases_error(self.post_request_individual_code_confirm_address_en,
                                                               'en')
    ...
    async def test_get_request_individual_code_confirm_address_get_cases_error_cy(self):
        ...
        await self.post_common_enter_address(self.post_request_individual_code_enter_address_cy, 'cy')
        await self.post_common_select_address(self.post_request_individual_code_select_address_cy, 'cy')
        await self.post_common_confirm_address_get_cases_error(self.post_request_individual_code_confirm_address_cy,
                                                               'cy')
    ...
    async def test_get_request_individual_code_confirm_address_get_cases_error_ni(self):
        ...
        await self.post_common_enter_address(self.post_request_individual_code_enter_address_ni, 'ni')
        await self.post_common_select_address(self.post_request_individual_code_select_address_ni, 'ni')
        await self.post_common_confirm_address_get_cases_error(self.post_request_individual_code_confirm_address_ni,
                                                               'ni')
    ...
    async def test_post_request_individual_code_enter_mobile_invalid_ew_e(self):
        ...
        await self.post_common_confirm_address_yes(self.post_request_individual_code_confirm_address_en,
                                                   'en', self.rhsvc_case_by_uprn_hh_e)
        await self.post_common_enter_mobile_invalid(self.post_request_individual_code_enter_mobile_en, 'en')
    ...
    async def test_post_request_individual_code_enter_mobile_invalid_cy(self):
        ...
        await self.post_common_confirm_address_yes(self.post_request_individual_code_confirm_address_cy,
                                                   'cy', self.rhsvc_case_by_uprn_hh_w)
        await self.post_common_enter_mobile_invalid(self.post_request_individual_code_enter_mobile_cy, 'cy')
    ...
    async def test_post_request_individual_code_enter_mobile_invalid_ni(self):
        ...
        await self.post_common_confirm_address_yes(self.post_request_individual_code_confirm_address_ni,
                                                   'ni', self.rhsvc_case_by_uprn_hh_n)
        await self.post_common_enter_mobile_invalid(self.post_request_individual_code_enter_mobile_ni, 'ni')
    ...
    async def test_request_individual_code_confirm_mobile_no_ew_e(self):
        ...
        await self.post_common_confirm_address_yes(self.post_request_individual_code_confirm_address_en,
                                                   'en', self.rhsvc_case_by_uprn_hh_e)
        await self.post_common_enter_mobile(self.post_request_individual_code_enter_mobile_en, 'en')
        await self.post_common_confirm_mobile_no(self.post_request_individual_code_confirm_mobile_en, 'en')
    ...
    async def test_request_individual_code_confirm_mobile_no_cy(self):
        ...
        await self.post_common_confirm_address_yes(self.post_request_individual_code_confirm_address_cy,
                                                   'cy', self.rhsvc_case_by_uprn_hh_w)
        await self.post_common_enter_mobile(self.post_request_individual_code_enter_mobile_cy, 'cy')
        await self.post_common_confirm_mobile_no(self.post_request_individual_code_confirm_mobile_cy, 'cy')
    ...
    async def test_request_individual_code_confirm_mobile_no_ni(self):
        ...
        await self.post_common_confirm_address_yes(self.post_request_individual_code_confirm_address_ni,
                                                   'ni', self.rhsvc_case_by_uprn_hh_n)
        await self.post_common_enter_mobile(self.post_request_individual_code_enter_mobile_ni, 'ni')
        await self.post_common_confirm_mobile_no(self.post_request_individual_code_confirm_mobile_ni, 'ni')
    ...
    async def test_request_individual_code_confirm_mobile_empty_ew_e(self):
        ...
        await self.post_common_confirm_address_yes(self.post_request_individual_code_confirm_address_en,
                                                   'en', self.rhsvc_case_by_uprn_hh_e)
        await self.post_common_enter_mobile(self.post_request_individual_code_enter_mobile_en, 'en')
        await self.post_common_confirm_mobile_empty_or_invalid(self.post_request_individual_code_confirm_mobile_en,
                                                               'en', self.request_code_mobile_confirmation_data_empty)
    ...
    async def test_request_individual_code_confirm_mobile_empty_cy(self):
        ...
        await self.post_common_confirm_address_yes(self.post_request_individual_code_confirm_address_cy,
                                                   'cy', self.rhsvc_case_by_uprn_hh_w)
        await self.post_common_enter_mobile(self.post_request_individual_code_enter_mobile_cy, 'cy')
        await self.post_common_confirm_mobile_empty_or_invalid(self.post_request_individual_code_confirm_mobile_cy,
                                                               'cy', self.request_code_mobile_confirmation_data_empty)
    ...
    async def test_request_individual_code_confirm_mobile_empty_ni(self):
        ...
        await self.post_common_confirm_address_yes(self.post_request_individual_code_confirm_address_ni,
                                                   'ni', self.rhsvc_case_by_uprn_hh_n)
        await self.post_common_enter_mobile(self.post_request_individual_code_enter_mobile_ni, 'ni')
        await self.post_common_confirm_mobile_empty_or_invalid(self.post_request_individual_code_confirm_mobile_ni,
                                                               'ni', self.request_code_mobile_confirmation_data_empty)
    ...
    async def test_request_individual_code_confirm_mobile_invalid_ew_e(self):
        ...
        await self.post_common_enter_mobile(self.post_request_individual_code_enter_mobile_en, 'en')
        await self.post_common_confirm_mobile_empty_or_invalid(self.post_request_individual_code_confirm_mobile_en,
                                                               'en', self.request_code_mobile_confirmation_data_invalid)
    ...
    async def test_request_individual_code_confirm_mobile_invalid_cy(self):
        ...
        await self.post_common_enter_mobile(self.post_request_individual_code_enter_mobile_cy, 'cy')
        await self.post_common_confirm_mobile_empty_or_invalid(self.post_request_individual_code_confirm_mobile_cy,
                                                               'cy', self.request_code_mobile_confirmation_data_invalid)
    ...
    async def test_request_individual_code_confirm_mobile_invalid_ni(self):
        ...
        await self.post_common_enter_mobile(self.post_request_individual_code_enter_mobile_ni, 'ni')
        await self.post_common_confirm_mobile_empty_or_invalid(self.post_request_individual_code_confirm_mobile_ni,
                                                               'ni', self.request_code_mobile_confirmation_data_invalid)
    ...
    async def test_request_individual_code_confirm_mobile_get_fulfilment_error_ew_e(self):
        ...
        await self.post_common_confirm_address_yes(self.post_request_individual_code_confirm_address_en,
                                                   'en', self.rhsvc_case_by_uprn_hh_e)
        await self.post_common_enter_mobile(self.post_request_individual_code_enter_mobile_en, 'en')
        await self.post_common_confirm_mobile_get_fulfilment_error(self.post_request_individual_code_confirm_mobile_en,
                                                                   'en', 'HH', 'E', 'true')
    ...
    async def test_request_individual_code_confirm_mobile_get_fulfilment_error_cy(self):
        ...
        await self.post_common_confirm_address_yes(self.post_request_individual_code_confirm_address_cy,
                                                   'cy', self.rhsvc_case_by_uprn_hh_w)
        await self.post_common_enter_mobile(self.post_request_individual_code_enter_mobile_cy, 'cy')
        await self.post_common_confirm_mobile_get_fulfilment_error(self.post_request_individual_code_confirm_mobile_cy,
                                                                   'cy', 'HH', 'W', 'true')
    ...
    async def test_request_individual_code_confirm_mobile_get_fulfilment_error_ni(self):
        ...
        await self.post_common_confirm_address_yes(self.post_request_individual_code_confirm_address_ni,
                                                   'ni', self.rhsvc_case_by_uprn_hh_n)
        await self.post_common_enter_mobile(self.post_request_individual_code_enter_mobile_ni, 'ni')
        await self.post_common_confirm_mobile_get_fulfilment_error(self.post_request_individual_code_confirm_mobile_ni,
                                                                   'ni', 'HH', 'N', 'true')
    ...
    async def test_request_individual_code_confirm_mobile_request_fulfilment_error_ew_e(self):
        ...
        await self.post_common_confirm_address_yes(self.post_request_individual_code_confirm_address_en,
                                                   'en', self.rhsvc_case_by_uprn_hh_e)
        await self.post_common_enter_mobile(self.post_request_individual_code_enter_mobile_en, 'en')
        await self.post_common_confirm_mobile_request_fulfilment_error(
