        ...
        with self.assertLogs('respondent-home', 'INFO') as cm, \
            ...
            if self.sub_user_journey == 'paper-form' and not override_sub_user_journey:
                ...
                if display_region == 'cy':
                    if fulfilment_type == 'LARGE_PRINT':
                        if individual == 'true':
                            self.assertIn(self.content_request_form_sent_post_individual_title_large_print_cy, contents)
                        else:
                    ...
                    if fulfilment_type == 'LARGE_PRINT':
                        if individual == 'true':
                            self.assertIn(self.content_request_form_sent_post_individual_title_large_print_en, contents)
                        else:
