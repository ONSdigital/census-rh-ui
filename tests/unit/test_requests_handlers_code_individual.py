...
class TestRequestsHandlersIndividualCode(RHTestCase):
    ...
    @unittest_run_loop
    async def test_request_individual_code_post_enter_name_empty_hh_ew_e(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
            ...
            resp_content = await response.content.read()
            self.assertIn(self.ons_logo_en, str(resp_content))
            self.assertIn('<a href="/cy/requests/individual-code/enter-name/" lang="cy" >Cymraeg</a>',
                          str(resp_content))
            self.assertIn(self.content_request_code_enter_name_title_en, str(resp_content))
            ...
            self.assertEqual(response.status, 200)
            resp_content = await response.content.read()
            self.assertIn(self.content_request_code_enter_name_error_first_name_en, str(resp_content))
            self.assertIn(self.content_request_code_enter_name_error_last_name_en, str(resp_content))
            self.assertIn(self.content_request_code_enter_name_title_en, str(resp_content))

    @unittest_run_loop
    async def test_request_individual_code_post_enter_name_empty_hh_ew_w(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_individual_code_post_enter_name_empty_hh_cy(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
            ...
            resp_content = await response.content.read()
            self.assertIn(self.ons_logo_cy, str(resp_content))
            self.assertIn('<a href="/en/requests/individual-code/enter-name/" lang="en" >English</a>',
                          str(resp_content))
            self.assertIn(self.content_request_code_enter_name_title_cy, str(resp_content))
            ...
            self.assertEqual(response.status, 200)
            resp_content = await response.content.read()
            self.assertIn(self.content_request_code_enter_name_error_first_name_cy, str(resp_content))
            self.assertIn(self.content_request_code_enter_name_error_last_name_cy, str(resp_content))
            self.assertIn(self.content_request_code_enter_name_title_cy, str(resp_content))

    @unittest_run_loop
    async def test_request_individual_code_post_enter_name_empty_hh_ni(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_individual_code_post_enter_name_no_first_hh_ew_e(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
            ...
            resp_content = await response.content.read()
            self.assertIn(self.content_request_code_enter_name_error_first_name_en, str(resp_content))
            self.assertNotIn(self.content_request_code_enter_name_error_last_name_en, str(resp_content))
            self.assertIn(self.content_request_code_enter_name_title_en, str(resp_content))

    @unittest_run_loop
    async def test_request_individual_code_post_enter_name_no_first_hh_ew_w(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_individual_code_post_enter_name_no_first_hh_cy(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
            ...
            resp_content = await response.content.read()
            self.assertIn(self.content_request_code_enter_name_error_first_name_cy, str(resp_content))
            self.assertNotIn(self.content_request_code_enter_name_error_last_name_cy, str(resp_content))
            self.assertIn(self.content_request_code_enter_name_title_cy, str(resp_content))

    @unittest_run_loop
    async def test_request_individual_code_post_enter_name_no_first_hh_ni(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_individual_code_post_enter_name_no_last_hh_ew_e(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
            ...
            self.assertEqual(response.status, 200)
            resp_content = await response.content.read()
            self.assertNotIn(self.content_request_code_enter_name_error_first_name_en, str(resp_content))
            self.assertIn(self.content_request_code_enter_name_error_last_name_en, str(resp_content))
            self.assertIn(self.content_request_code_enter_name_title_en, str(resp_content))

    @unittest_run_loop
    async def test_request_individual_code_post_enter_name_no_last_hh_ew_w(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_individual_code_post_enter_name_no_last_hh_cy(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
            ...
            self.assertEqual(response.status, 200)
            resp_content = await response.content.read()
            self.assertNotIn(self.content_request_code_enter_name_error_first_name_cy, str(resp_content))
            self.assertIn(self.content_request_code_enter_name_error_last_name_cy, str(resp_content))
            self.assertIn(self.content_request_code_enter_name_title_cy, str(resp_content))

    @unittest_run_loop
    async def test_request_individual_code_post_enter_name_no_last_hh_ni(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_individual_code_post_confirm_name_address_empty_hh_ew_e(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
            ...
            resp_content = await response.content.read()
            self.assertIn(self.ons_logo_en, str(resp_content))
            self.assertIn('<a href="/cy/requests/individual-code/confirm-name-address/" lang="cy" >Cymraeg</a>',
                          str(resp_content))
    ...
    @unittest_run_loop
    async def test_request_individual_code_post_confirm_name_address_empty_hh_ew_w(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_individual_code_post_confirm_name_address_empty_hh_cy(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
            ...
            resp_content = await response.content.read()
            self.assertIn(self.ons_logo_cy, str(resp_content))
            self.assertIn('<a href="/en/requests/individual-code/confirm-name-address/" lang="en" >English</a>',
                          str(resp_content))
    ...
    @unittest_run_loop
    async def test_request_individual_code_post_confirm_name_address_empty_hh_ni(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_individual_code_post_confirm_name_address_invalid_hh_ew_e(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_individual_code_post_confirm_name_address_invalid_hh_ew_w(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_individual_code_post_confirm_name_address_invalid_hh_cy(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_individual_code_post_confirm_name_address_invalid_hh_ni(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_individual_code_post_confirm_name_address_option_no_hh_ew_e(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_individual_code_post_confirm_name_address_option_no_hh_ew_w(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_individual_code_post_confirm_name_address_option_no_hh_cy(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_individual_code_post_confirm_name_address_option_no_hh_ni(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_individual_code_confirm_name_address_get_fulfilment_error_ew_e(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
                'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            ...
            mocked_get_case_by_uprn.return_value = self.rhsvc_case_by_uprn_hh_e
            mocked_aioresponses.get(self.rhsvc_url_fulfilments +
                                    '?caseType=HH&region=E&deliveryChannel=POST&productGroup=UAC&individual=true',
                                    status=400)
    ...
    @unittest_run_loop
    async def test_request_individual_code_confirm_name_address_get_fulfilment_error_ew_w(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
                'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            ...
            mocked_get_case_by_uprn.return_value = self.rhsvc_case_by_uprn_hh_w
            mocked_aioresponses.get(self.rhsvc_url_fulfilments +
                                    '?caseType=HH&region=W&deliveryChannel=POST&productGroup=UAC&individual=true',
                                    status=400)
    ...
    @unittest_run_loop
    async def test_request_individual_code_confirm_name_address_get_fulfilment_error_cy(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
                'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_individual_code_confirm_name_address_get_fulfilment_error_ni(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
                'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
            ...
            mocked_get_case_by_uprn.return_value = self.rhsvc_case_by_uprn_hh_n
            mocked_aioresponses.get(self.rhsvc_url_fulfilments +
                                    '?caseType=HH&region=N&deliveryChannel=POST&productGroup=UAC&individual=true',
                                    status=400)
    ...
    @unittest_run_loop
    async def test_request_individual_code_confirm_name_address_request_fulfilment_error_ew_e(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
                'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_individual_code_confirm_name_address_request_fulfilment_error_ew_w(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode') as mocked_get_ai_postcode, mock.patch(
                'app.utils.AddressIndex.get_ai_uprn') as mocked_get_ai_uprn, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_individual_code_confirm_name_address_request_fulfilment_error_cy(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
    ...
    @unittest_run_loop
    async def test_request_individual_code_confirm_name_address_request_fulfilment_error_ni(
            self):
        with self.assertLogs('respondent-home', 'INFO') as cm, mock.patch(
                'app.utils.AddressIndex.get_ai_postcode'
        ) as mocked_get_ai_postcode, mock.patch(
