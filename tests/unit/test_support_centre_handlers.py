...
class TestSupportCentre(RHTestCase):
    ...
    async def test_get_support_centre_list_of_centres_single_result_en(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, \
            ...
            self.assertIn(self.content_support_centre_list_of_centres_result_one_times_monday_en, resp_content)
            self.assertIn(self.content_support_centre_list_of_centres_result_one_times_tuesday_en, resp_content)
            self.assertIn(self.content_support_centre_list_of_centres_result_one_times_sunday_en, resp_content)
            self.assertIn(self.content_support_centre_list_of_centres_result_one_times_census_saturday_en, resp_content)
            self.assertIn(self.content_support_centre_list_of_centres_result_one_times_census_day_en, resp_content)
    ...
    async def test_get_support_centre_list_of_centres_single_result_cy(self):
        with self.assertLogs('respondent-home', 'INFO') as cm, \
            ...
            self.assertIn(self.content_support_centre_list_of_centres_result_one_times_monday_cy, resp_content)
            self.assertIn(self.content_support_centre_list_of_centres_result_one_times_tuesday_cy, resp_content)
            self.assertIn(self.content_support_centre_list_of_centres_result_one_times_sunday_cy, resp_content)
            self.assertIn(self.content_support_centre_list_of_centres_result_one_times_census_saturday_cy, resp_content)
            self.assertIn(self.content_support_centre_list_of_centres_result_one_times_census_day_cy, resp_content)
