...
MOBILE_CHECK_MSG = {'text': 'Please check and confirm your mobile phone number', 'level': 'ERROR', 'type': 'MOBILE_CONFIRMATION_ERROR', 'field': 'mobile'}  # NOQA
...
ADDRESS_CHECK_MSG_CY = {'text': "Edrychwch eto ar y cyfeiriad a'i gadarnhau", 'level': 'ERROR', 'type': 'ADDRESS_CONFIRMATION_ERROR', 'field': 'address'}  # NOQA
