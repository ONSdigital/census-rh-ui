...
SESSION_TIMEOUT_MSG = {'text': 'Apologies, your session has timed out. Please re-enter your access code.', "level": "ERROR", "type": "SYSTEM_AUTH_ERROR", "field": "uac"}
...
WEBCHAT_MISSING_EMAIL_MSG = {'text': 'Enter your email address', "clickable": True, "level": "ERROR", "type": "BAD_CODE", "field": "email"}  # NOQA
